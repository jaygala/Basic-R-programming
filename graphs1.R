...
women
plot(women)
plot(women, type='p', pch=17)   #p means point and pch means plotting symbol
plot(women, type='l')   #l means line
plot(women, type='b', pch=18, lty=2, col=2)   #b means both p and l ; lty means line type
...
plot(women)
abline(lm(women$weight ~ women$height), col='red', lty=2, lwd=4)   # abline means ADD LINE
